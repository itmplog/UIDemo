...
public class MakeToast {
    ...
    public static void Short(CharSequence charSequence) {
        Toast.makeText(TopApplication.getContext(), charSequence, Toast.LENGTH_SHORT).show();
    }

    public static void Long(CharSequence charSequence) {
        Toast.makeText(TopApplication.getContext(), charSequence, Toast.LENGTH_LONG).show();
    }
}
